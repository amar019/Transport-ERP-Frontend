...
export const BookingDetailsPage = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-50 p-6 flex flex-col items-center justify-center">
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xs flex flex-col items-center gap-3">
  ...
  if (!booking || error) {
    return (
      <div className="min-h-screen bg-slate-50 p-4 md:p-8 max-w-4xl mx-auto select-none">
        <button
          type="button"
        ...
        <div className="bg-white p-10 rounded-3xl border border-rose-200 shadow-xs text-center">
          ...
          <p className="text-xs text-slate-500 font-medium mt-1 mb-6 max-w-sm mx-auto">
            {typeof error === "string"
              ? error
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-3 md:p-6 font-sans antialiased text-slate-800 selection:bg-orange-100 select-none pb-16">
      {/* Toast Alert Banner */}
      {toast && (
        <div
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-slate-200/80">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <span className="text-[11px] font-mono font-bold bg-slate-100 text-slate-700 px-2.5 py-1 rounded-lg border border-slate-200/80 shadow-2xs">
              System Ref: <span className="text-slate-900 font-extrabold">#{id.slice(-6)}</span>
            </span>
          </div>
        </div>

        {/* HERO COMMAND HEADER CARD */}
        <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xs p-5 md:p-6 transition-all">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
            {/* Left: Booking ID, Badges, & Key Metadata */}
            <div className="space-y-2">
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-2">
                  <span className="font-mono text-base md:text-xl font-black bg-orange-50 text-orange-700 px-3.5 py-1 rounded-xl border border-orange-200/90 shadow-2xs">
              ...
              <div className="flex flex-wrap items-center gap-y-1 gap-x-4 text-xs font-semibold text-slate-500">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    Created by <b className="text-slate-700">{booking.createdBy?.name || booking.createdBy?.username || "Operator"}</b>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center flex-wrap gap-2.5">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-extrabold px-4 py-2.5 rounded-xl shadow-md shadow-orange-500/20 active:scale-[0.98] transition-all text-xs md:text-sm cursor-pointer"
              >
              ...
              {canEdit && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-2.5 text-xs font-extrabold text-slate-700 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl transition-all cursor-pointer shadow-2xs"
                >
              ...
              {canCancel && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-2.5 text-xs font-extrabold text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-xl transition-all cursor-pointer"
                >
              ...
              {canDelete && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-2.5 text-xs font-bold text-slate-500 hover:text-rose-700 hover:bg-rose-50 rounded-xl transition-all cursor-pointer"
          ...
          {isMemoAssigned && (
            <div className="mt-4 pt-3.5 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-amber-50/60 p-3.5 rounded-2xl border border-amber-200/80">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-lg bg-amber-100 text-amber-700 flex items-center justify-center shrink-0">
                  <Lock className="w-3.5 h-3.5" />
                </div>
                <div>
                  <span className="text-[11px] font-black uppercase text-amber-800 tracking-tight block">
              ...
              {memoId && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-black text-amber-900 bg-white hover:bg-amber-100 px-3 py-1.5 rounded-xl border border-amber-200 shadow-2xs transition-all cursor-pointer self-start sm:self-auto"
                >
                  <span>Open Memo</span>
          ...
          <div className="lg:col-span-8 space-y-5">
            ...
            <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xs p-5 md:p-6 space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-lg bg-orange-50 text-orange-600 flex items-center justify-center font-bold border border-orange-100">
                ...
                <span className="text-[10px] uppercase font-black px-2 py-0.5 bg-slate-100 text-slate-600 rounded-md">
                  Direct Station Line
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 relative">
                ...
                {/* Destination Branch */}
                <div className="bg-orange-50/50 p-4 rounded-2xl border border-orange-200/80 space-y-1">
                  <div className="flex items-center justify-between">
                ...
                <div className="bg-slate-50/90 p-4 rounded-2xl border border-slate-200/80 space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-slate-200/60">
                    ...
                    {customer.customerCode && (
                      <span className="text-[9px] font-mono font-black bg-orange-100 text-orange-800 px-1.5 py-0.5 rounded">
                        {customer.customerCode}
                      </span>
                    )}
                  </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xs p-5 md:p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-3.5">
                <div className="sm:col-span-8 bg-slate-50 p-4 rounded-2xl border border-slate-200/80">
                ...
                <div className="sm:col-span-4 bg-slate-50 p-4 rounded-2xl border border-slate-200/80 text-center flex flex-col justify-center">
                  <span className="text-[10px] font-black uppercase text-slate-400 block mb-1">
                    Total Quantity
                  </span>
          ...
          <div className="lg:col-span-4 space-y-5 lg:sticky lg:top-6">
            ...
            <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xs p-5 md:p-6 space-y-5">
              <div className="flex items-center justify-between pb-3.5 border-b border-slate-100">
                ...
                <span className="text-[10px] uppercase font-black px-2 py-0.5 bg-orange-50 text-orange-700 rounded-md border border-orange-200/80">
                  INR (₹)
                </span>
              </div>
              ...
              {/* TOTAL AMOUNT HIGHLIGHT BANNER (NO BLACK THEME) */}
