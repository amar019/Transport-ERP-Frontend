      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 max-w-lg w-full text-center shadow-sm space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-slate-500 text-xs leading-relaxed max-w-md mx-auto">
            The <strong className="text-slate-700">{title}</strong> module is
            configured and ready for implementation. You can navigate between all
            sidebar sections seamlessly.
          </p>
        </div>
