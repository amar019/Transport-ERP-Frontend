...
import { login as loginThunk } from "../store/thunk/authThunk.js";
    ...
    <div className="min-h-screen w-full bg-[#f3f4f6] flex items-center justify-center py-6 md:py-10 px-4 font-sans antialiased selection:bg-orange-100">
      ...
      <div className="bg-white w-full max-w-[420px] p-6 md:p-8 rounded-[2rem] shadow-xl border border-slate-100 flex flex-col justify-center my-auto">
        ...
        <div className="flex flex-col items-center mb-4 select-none">
          ...
          <p className="text-[9px] text-slate-400 font-medium tracking-widest uppercase mt-0.5">Manage | Track | Deliver</p>
        </div>
        ...
        <div className="w-full mb-4 rounded-xl overflow-hidden shadow-sm border border-slate-100/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5 text-left">
              ...
              <div className="relative group">
                <div className={`absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 ${
                  (fieldErrors.username || error) ? "text-rose-500" : "group-focus-within:text-orange-500"
                } transition-colors`}>
            ...
            <div className="space-y-1.5 text-left">
              ...
              <div className="relative group">
                <div className={`absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 ${
                  (fieldErrors.password || error) ? "text-rose-500" : "group-focus-within:text-orange-500"
                } transition-colors`}>
                ...
                <button
                  ...
                  className={`absolute inset-y-0 right-0 pr-3.5 flex items-center ${
                    (fieldErrors.password || error) ? "text-rose-400 hover:text-rose-600" : "text-slate-400 hover:text-slate-600"
                  } focus:outline-none`}
                >
