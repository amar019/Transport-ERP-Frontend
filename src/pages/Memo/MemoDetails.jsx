...
export default function MemoDetails() {
  ...
  const totalToPay = memo.totalAmount ?? memo.totalToPay ?? 0;
  const settledAmount = memo.receivedAmount ?? memo.totalCollected ?? 0;
  const pendingBalance = memo.pendingAmount ?? (totalToPay - settledAmount);
  const totalQuantity =
    memo.totalPackages ??
      ...
      <div className="max-w-5xl mx-auto mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs">
          ...
          <div className="flex items-center flex-wrap gap-2">
            ...
            <button
              type="button"
              onClick={() => navigate(`/memo-preview?id=${id}`)}
            ...
            {/* Settle Collection Button (BOOKING only) */}
            {canSettle && (
              <button
                type="button"
                onClick={() => {
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-white bg-amber-600 hover:bg-amber-700 rounded-xl shadow-md transition-all cursor-pointer"
              >
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
            <span className="text-[10px] font-bold uppercase text-slate-400 block">Total Bilties</span>
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
            <span className="text-[10px] font-bold uppercase text-slate-400 block">Total Quantity</span>
            <span className="text-xl font-black text-slate-800 mt-1 block">
              {totalQuantity} Cartons
            </span>
          </div>

          <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
            <span className="text-[10px] font-bold uppercase text-slate-400 block">TO_PAY Value</span>
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
            <span className="text-[10px] font-bold uppercase text-slate-400 block">Settled Amount</span>
